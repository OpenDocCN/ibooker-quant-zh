...
然而，如果没有硬件方面的进步，最近的 AI 成就是不可能的。再次，DeepMind 以及其通过强化学习（RL）掌握围棋的努力提供了一些宝贵的见解。Table 2-1 概述了从 2015 年以来各个主要 AlphaGo 版本的硬件使用和功耗情况。^(8) AlphaGo 的实力不仅稳步增强，而且硬件要求及相关功耗也显著降低。^(9)
...
^(8) 欲了解更多信息，请参见：[*https://oreil.ly/im174*](https://oreil.ly/im174)。
